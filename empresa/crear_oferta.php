...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($titulo && $area) {
        if (Oferta::crear($id_empresa, $titulo, $descripcion, $ubicacion, $area)) {
            ...
            $errores = "Error al crear la oferta";
        }
    } else {
...
<head>
    ...
    <title>Nattworld — Publicar oferta</title>
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="area" class="form-control" placeholder="Ej: Tecnologia, Marketing, Diseno" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Ubicacion</label>
                                    <input type="text" name="ubicacion" class="form-control" placeholder="Ej: Madrid, Remoto">
                                </div>
                            </div>
                            <div class="mb-3">
