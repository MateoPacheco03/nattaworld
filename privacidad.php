...
<body>
    ...
    <main>
        ...
        <div class="legal-hero">
            <span class="eyebrow">Marco legal · RGPD</span>
            <h1>Política de Privacidad</h1>
            <p class="meta">Última actualización: 30 mayo 2026 · Versión 2.0 · Conforme RGPD (UE) 2016/679 + LOPDGDD</p>
        </div>
        ...
        <div class="legal-wrapper">
            ...
            <ul>
                ...
                <li>Datos profesionales (candidatos): formación, aptitudes, resultados de pruebas, experiencia y preferencias laborales.</li>
                <li>Datos de empresa: razón social, identificación fiscal y datos de la persona de contacto autorizada.</li>
                <li>Datos técnicos: dirección IP, navegador, sistema operativo e información de uso, con fines de seguridad y mejora.</li>
            </ul>

            <h2>4. Finalidades del tratamiento</h2>
            <p>Tratamos tus datos personales con las siguientes finalidades legítimas y determinadas:</p>
            <ul>
                <li>Gestionar tu registro, autenticación y acceso a tu cuenta.</li>
                <li>Poner en contacto a candidatos y empresas según las aptitudes declaradas.</li>
                <li>Facilitar la publicación, búsqueda y gestión de ofertas de empleo junior.</li>
                <li>Remitir comunicaciones operativas relacionadas con el servicio.</li>
                <li>Garantizar la seguridad de la plataforma y prevenir usos fraudulentos.</li>
                <li>Cumplir las obligaciones legales, fiscales y contables aplicables.</li>
            </ul>

            <h2>5. Base jurídica del tratamiento</h2>
            <p>El tratamiento se fundamenta en las bases del artículo 6 del RGPD: la ejecución del contrato de servicios que solicitas al registrarte, tu consentimiento libre y específico, el cumplimiento de obligaciones legales y el interés legítimo en la seguridad y mejora del servicio.</p>
            ...
            <p>La normativa te reconoce derechos que puedes ejercer gratuitamente en cualquier momento:</p>
            <ul>
                <li>Acceso: conocer qué datos tratamos sobre ti.</li>
